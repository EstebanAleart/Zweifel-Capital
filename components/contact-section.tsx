      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-12">
          ...
          <Card className="bg-card/30 border-border/50">
            <CardHeader>
              <CardTitle className="text-2xl font-serif font-medium text-foreground">Contact Information</CardTitle>
            </CardHeader>
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="text-muted-foreground">
                    <span className="text-foreground font-medium">Bahamas:</span>
                    <br />
          ...
          <Card className="bg-card/30 border-border/50">
            <CardHeader>
              <CardTitle className="text-2xl font-serif font-medium text-foreground">Schedule a Consultation</CardTitle>
            </CardHeader>
            <CardContent className="space-y-6">
              ...
              <div className="space-y-4">
                ...
                <Button
                  variant="outline"
                  className="w-full border-border text-foreground hover:bg-secondary py-6 text-base font-medium"
                  onClick={() => {
              ...
              <div className="pt-4 border-t border-border/50">
                <p className="text-sm text-muted-foreground">
                  <span className="text-foreground">Response Time:</span> We typically respond within 24 hours during business days.
                </p>
              </div>
            </CardContent>
          </Card>
